...
<p>This page is appointed to create new and managing existing ibeacons by admin</p>
    ...
    <fieldset>
        ...
        <div class='control-group'>
            <div class='controls'>
                ...
                <div class='span1'>
                 <img class='img-rounded' title='ibeacons' src="<?php echo Yii::app()->getBaseUrl(true) . '/image/ibc.png' ?>" />    
                </div>
                <div class='span3'>
